...
const PublicUserProfile: React.FC = () => {
  ...
  // لا تظهر أزرار المتابعة/المراسلة على بروفايل البوت
  const shouldShowFollowButton = !isOwnProfile && !!profile?.id && !isKotobiBot;
  const shouldShowMessageButton = !isOwnProfile && !!profile?.id && !isKotobiBot;
          ...
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <Card className="mb-8 overflow-hidden bg-card/90 backdrop-blur-md border-border/40 rounded-2xl shadow-md">
              <CardContent className="p-5 md:p-6 text-center">
                ...
                {/* أزرار المتابعة والمراسلة - تخفى تماماً على بروفايل البوت */}
                {!interactionLoading && !isKotobiBot && (shouldShowFollowButton || shouldShowMessageButton) && (
